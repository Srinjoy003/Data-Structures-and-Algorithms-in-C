...
void print(skiplist* list){
    ...
    x = x->forward[level];
    printf("%d %d %d %d %d %d",x->forward[0]->key,x->forward[1]->key,x->forward[2]->key,x->forward[3]->key,x->forward[4]->key,x->forward[5]->key);
...
int main() {
    ...
    print(&list);
    //snode *x = skiplist_search(&list, 11);
